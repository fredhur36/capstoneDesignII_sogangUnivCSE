            ...
            public void didRangeBeaconsInRegion(Collection<Beacon> beacons, Region region) {
                ...
                if (beacons.size() > 0 ) {
                    ...
                    while (iterator.hasNext()) {
                            ...
                            String ID = beacon.getBluetoothName();
                         //   System.out.println("what it is : "+ID);
                            ...
                            if(ID.equals(input)) {
                                flag = true;
                                items.add(new Item(ID, address, rssi, txPower, distance, major, minor, near));
                            }
                            else continue;
